...
def main():
    ...
    if args.model_file != '':
        ...
        print('Model loaded: ', args.model_file)
    model.to(device)
    ...
    if args.dataset == 'COLLAB':
        scheduler = torch.optim.lr_scheduler.CyclicLR(optimizer, 
                                                    ...
                                                    step_size_up = 25, #step_size_down = 40, 
                                                    mode = 'exp_range', gamma= 0.99995, 
                                                    cycle_momentum = False, verbose=True)
    ...
    if args.dataset == 'IMDB-BINARY':
        scheduler = torch.optim.lr_scheduler.CyclicLR(optimizer, 
                                                    ...
                                                    step_size_up = 40, #step_size_down = 40, 
                                                    mode = 'exp_range', gamma= 0.99995, 
                                                    cycle_momentum = False, verbose=True)
        args.epochs = 200
    ...
    args.result_path = 'results_hptune' + '/' + args.dataset + '/' + model_name + '/' + str(args.seed) + '/'
    ...
    with open(args.result_path + '/result.txt', 'a+') as f:
        f.write("{} {} {} {}\n".format(
            args.seed, valid_ap[valid_max_idx], test_ap[valid_max_idx], args.model_file))    
